...
[ node_xyz, triangle_node ] =file_read ( node_file_name, ...
    triangle_file_name, dim_num, node_num, order_num, triangle_num );
triangle_normal = face_normal ( node_num, triangle_num, ...
...
function column_num = column_count ( input_file_name )
...
if ( input_unit < 0 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'column_count - Error!\n' );
    fprintf ( 1, '  Could not open the file "%s".\n', input_file_name );
    error ( 'column_count - Error!' );
end
...
if ( got_one == FALSE )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'column_count - Warning!\n' );
...
function row_num = row_count ( input_file_name )

input_unit = fopen ( input_file_name );

if ( input_unit < 0 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'row_count - Error!\n' );
    fprintf ( 1, '  Could not open the file "%s".\n', input_file_name );
    error ( 'row_count - Error!' );
end
...
function table = data_read1 ( input_filename, m, n )
table = zeros ( m, n );
string = ' ';
...
if ( input_unit < 0 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'data_read1 - Error!\n' );
    fprintf ( 1, '  Could not open the input file.\n' );
    error ( 'data_read1 - Error!' );
end
...
function [ m, n ] = header_read1 ( input_filename )
m = column_count ( input_filename );

if ( m <= 0 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'header_read1 - Fatal error!\n' );
    fprintf ( 1, '  There was some kind of I/O problem while trying\n' );
    fprintf ( 1, '  to count the number of data columns in\n' );
    fprintf ( 1, '  the file %s.\n', input_filename );
end

n = row_count ( input_filename );
...
function table = data_read2 ( input_filename, m, n )
string = ' ';
...
if ( input_unit < 0 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'data_read2 - Error!\n' );
    fprintf ( 1, '  Could not open the file.\n' );
    error ( 'data_read2 - Error!' );
end
...
function [ m, n ] = header_read2 ( input_filename )
m = column_count ( input_filename );

if ( m <= 0 )
    fprintf ( 1, '\n' );
    fprintf ( 1, 'header_read2 - Fatal error!\n' );
    fprintf ( 1, '  There was some kind of I/O problem while trying\n' );
    fprintf ( 1, '  to count the number of data columns in\n' );
    fprintf ( 1, '  the file %s.\n', input_filename );
end
...
function face_normal = face_normal ( node_num, face_num, ...
    node_xyz, face_node )
...
function [ node_xyz, triangle_node ] =file_read ( node_file_name, ...
    triangle_file_name, dim_num, node_num, order_num, triangle_num )


node_xyz = data_read2 ( node_file_name, dim_num, node_num );

triangle_node = data_read1 ( triangle_file_name, order_num, ...
    triangle_num );
...
function [ dim_num, node_num, order_num, triangle_num ] = file_size ( ...
    node_file_name, triangle_file_name )
[ dim_num, node_num ] = header_read2 ( node_file_name );
...
[ order_num, triangle_num ] = header_read1 ( triangle_file_name );
